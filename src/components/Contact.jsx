    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/ff58c1af-5045-4a31-a1e4-3453c0bdb1e2" 
                className='flex flex-col w-full md:w-1/2' method="POST">
                    ...
                    <textarea name="message" placeholder='Enter your Message' rows="10" className='p2 bg-transparent border-2 rounded-md text-white focus:outline-none'>
